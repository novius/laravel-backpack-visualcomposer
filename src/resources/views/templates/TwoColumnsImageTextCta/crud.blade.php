@php $columns = range(0, 1) @endphp

<div class="row-template vc-two-columns-image-text-cta">
...
@push('crud_fields_styles')
    <style>
        .vc-two-columns-image-text-cta .cke_chrome {
            width: 100%;
        }
        .vc-two-columns-image-text-cta input {
            display: block;
            width: 100%;
            margin: 1rem 0;
        }
        .vc-two-columns-image-text-cta .float-left {
            width: 49%;
            float: left;
        }
        .vc-two-columns-image-text-cta img {
            height: 250px;
            width: 100%;
            object-fit: contain;
            margin: auto;
        ...
        .vc-two-columns-image-text-cta img[src=""] {
            display: none;
        }
    </style>
@endpush
